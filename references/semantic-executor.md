...
2. Include every required node, participant, entity, state, message, fragment, edge, and group from the lock.
...
8. Preserve type-native meaning in source: data objects are not actions, pseudo-states remain unlabeled, sequence fragments keep their locked message membership, and call/return kinds are not collapsed.
